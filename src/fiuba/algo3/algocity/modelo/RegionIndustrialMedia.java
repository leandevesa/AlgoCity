...
public class RegionIndustrialMedia extends RegionIndustrial {
	
	public RegionIndustrialMedia(Posicion unaPosicion, Dimension unaDimension, Mapa mapa) {
		pathImagen = "src/fiuba/algo3/algocity/modelo/imagenes/regionIndustrialMedia.png";
		...
		pathImagenEdificio = "src/fiuba/algo3/algocity/modelo/imagenes/fabrica_regionmedia.png";
		this.mapa = mapa;
	}

	@Override
	protected EdificioIndustrial getEdificioAConstruir(Posicion unaPosicion) {
		return new EdificioIndustrialMedia(unaPosicion, mapa);
	}
